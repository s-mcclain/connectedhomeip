...
- (NSString *)description
{
    NSString * descriptionString = [NSString stringWithFormat:@"<%@: wiFiDevIK:%@; bleDeviceId:%@; timeOfMeasurement:%@; distance:%@; accuracy:%@; rdr:%@; rssi:%@; txPower:%@; >", NSStringFromClass([self class]), [_wiFiDevIK base64EncodedStringWithOptions:0], _bleDeviceId, _timeOfMeasurement, _distance, _accuracy, _rdr, _rssi, _txPower];
    return descriptionString;
}
...
- (NSString *)description
{
    NSString * descriptionString = [NSString stringWithFormat:@"<%@: role:%@; peerBLEDeviceID:%@; pmk:%@; >", NSStringFromClass([self class]), _role, _peerBLEDeviceID, [_pmk base64EncodedStringWithOptions:0]];
    return descriptionString;
}

@end

@implementation MTRProximityRangingClusterBTChannelSoundingDeviceRoleConfigStruct
- (instancetype)init
{
    if (self = [super init]) {
...
- (id)copyWithZone:(NSZone * _Nullable)zone
{
    auto other = [[MTRProximityRangingClusterBTChannelSoundingDeviceRoleConfigStruct alloc] init];

    other.role = self.role;
    other.targetPeerDevIK = self.targetPeerDevIK;
    other.pmk = self.pmk;
...
- (NSString *)description
{
    NSString * descriptionString = [NSString stringWithFormat:@"<%@: role:%@; targetPeerDevIK:%@; pmk:%@; >", NSStringFromClass([self class]), _role, [_targetPeerDevIK base64EncodedStringWithOptions:0], [_pmk base64EncodedStringWithOptions:0]];
    return descriptionString;
}
...
- (id)copyWithZone:(NSZone * _Nullable)zone
{
    ...
    other.mobilitySupport = self.mobilitySupport;
...
- (NSString *)description
{
    NSString * descriptionString = [NSString stringWithFormat:@"<%@: technology:%@; frequencyBand:%@; mobilitySupport:%@; periodicRangingSupport:%@; >", NSStringFromClass([self class]), _technology, _frequencyBand, _mobilitySupport, _periodicRangingSupport];
    return descriptionString;
}
...
- (id)copyWithZone:(NSZone * _Nullable)zone
{
    ...
    other.startTimeDelay = self.startTimeDelay;
    other.endTimeDelay = self.endTimeDelay;
...
- (NSString *)description
{
    NSString * descriptionString = [NSString stringWithFormat:@"<%@: startTimeDelay:%@; endTimeDelay:%@; rangingInstanceInterval:%@; >", NSStringFromClass([self class]), _startTimeDelay, _endTimeDelay, _rangingInstanceInterval];
    return descriptionString;
}
...
- (id)copyWithZone:(NSZone * _Nullable)zone
{
    ...
    other.startTimePeriod = self.startTimePeriod;
    other.endTimePeriod = self.endTimePeriod;
...
- (NSString *)description
{
    NSString * descriptionString = [NSString stringWithFormat:@"<%@: minDistanceCondition:%@; maxDistanceCondition:%@; accuracyCondition:%@; startTimePeriod:%@; endTimePeriod:%@; >", NSStringFromClass([self class]), _minDistanceCondition, _maxDistanceCondition, _accuracyCondition, _startTimePeriod, _endTimePeriod];
    return descriptionString;
}

@end

@implementation MTRProximityRangingClusterUWBRangingDeviceRoleConfigStruct
- (instancetype)init
{
    if (self = [super init]) {
...
- (id)copyWithZone:(NSZone * _Nullable)zone
{
    auto other = [[MTRProximityRangingClusterUWBRangingDeviceRoleConfigStruct alloc] init];

    other.role = self.role;
    other.targetPeerDevIK = self.targetPeerDevIK;
    other.pasnCredential = self.pasnCredential;
...
- (NSString *)description
{
    NSString * descriptionString = [NSString stringWithFormat:@"<%@: role:%@; targetPeerDevIK:%@; pasnCredential:%@; >", NSStringFromClass([self class]), _role, [_targetPeerDevIK base64EncodedStringWithOptions:0], [_pasnCredential base64EncodedStringWithOptions:0]];
    return descriptionString;
}
