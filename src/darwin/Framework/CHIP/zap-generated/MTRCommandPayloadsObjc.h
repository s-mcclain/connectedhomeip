...
@property (nonatomic, copy) MTRProximityRangingClusterBTChannelSoundingDeviceRoleConfigStruct * _Nullable btChannelSoundingDeviceRoleConfig MTR_PROVISIONALLY_AVAILABLE;

@property (nonatomic, copy) MTRProximityRangingClusterUWBRangingDeviceRoleConfigStruct * _Nullable uwbRangingDeviceRoleConfig MTR_PROVISIONALLY_AVAILABLE;
...
@property (nonatomic, copy) NSNumber * _Nullable securityMode MTR_PROVISIONALLY_AVAILABLE;
...
@property (nonatomic, copy) NSData * _Nullable targetWiFiDevIK MTR_PROVISIONALLY_AVAILABLE;

@property (nonatomic, copy) NSNumber * _Nullable targetBLEDeviceId MTR_PROVISIONALLY_AVAILABLE;
...
MTR_PROVISIONALLY_AVAILABLE
@interface MTRProximityRangingClusterRangingResultParams : NSObject <NSCopying>
...
/**
 * Initialize an MTRProximityRangingClusterRangingResultParams with a response-value dictionary
 * of the sort that MTRDeviceResponseHandler would receive.
 *
 * Will return nil and hand out an error if the response-value dictionary is not
 * a command data response or is not the right command response.
