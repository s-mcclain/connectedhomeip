...
public class ClusterIDMapping {
    ...
    public static class ProximityRanging implements BaseCluster {
        ...
        }public enum StartRangingRequestCommandField {Technology(0),WiFiRangingDeviceRoleConfig(1),BLERangingDeviceRoleConfig(2),BTChannelSoundingDeviceRoleConfig(3),UWBRangingDeviceRoleConfig(4),FrequencyBand(5),Bandwidth(6),SecurityMode(7),Trigger(8),ReportingCondition(9),;
                    private final int id;
