...
class ProximityRangingClusterRDRStruct(
  ...
  companion object {
    ...
    fun fromTlv(tlvTag: Tag, tlvReader: TlvReader): ProximityRangingClusterRDRStruct {
      ...
      val azimuth = tlvReader.getShort(ContextSpecificTag(TAG_AZIMUTH))
      val elevation = tlvReader.getByte(ContextSpecificTag(TAG_ELEVATION))
      ...
      val reference = tlvReader.getByte(ContextSpecificTag(TAG_REFERENCE))
