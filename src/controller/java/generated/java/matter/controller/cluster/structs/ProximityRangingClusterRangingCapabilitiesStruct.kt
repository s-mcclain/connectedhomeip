...
class ProximityRangingClusterRangingCapabilitiesStruct(
  ...
  val frequencyBand: UByte,
  val mobilitySupport: Boolean,
  ...
  override fun toString(): String = buildString {
    ...
    append("\tmobilitySupport : $mobilitySupport\n")
  ...
  fun toTlv(tlvTag: Tag, tlvWriter: TlvWriter) {
    tlvWriter.apply {
      ...
      put(ContextSpecificTag(TAG_MOBILITY_SUPPORT), mobilitySupport)
  ...
  companion object {
    ...
    private const val TAG_MOBILITY_SUPPORT = 2
    private const val TAG_PERIODIC_RANGING_SUPPORT = 3
    ...
    fun fromTlv(
      ...
      val frequencyBand = tlvReader.getUByte(ContextSpecificTag(TAG_FREQUENCY_BAND))
      val mobilitySupport = tlvReader.getBoolean(ContextSpecificTag(TAG_MOBILITY_SUPPORT))
