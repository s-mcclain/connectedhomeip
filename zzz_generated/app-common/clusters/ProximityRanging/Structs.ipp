...
CHIP_ERROR Type::Encode(TLV::TLVWriter & aWriter, TLV::Tag aTag) const
{
    DataModel::WrappedStructEncoder encoder{ aWriter, aTag };
    encoder.Encode(to_underlying(Fields::kRole), role);
    encoder.Encode(to_underlying(Fields::kTargetPeerDevIK), targetPeerDevIK);
    encoder.Encode(to_underlying(Fields::kPmk), pmk);
    return encoder.Finalize();
}
...
CHIP_ERROR DecodableType::Decode(TLV::TLVReader & reader)
{
    ...
    while (true)
    {
        ...
        else if (__context_tag == to_underlying(Fields::kTargetPeerDevIK))
        {
            err = DataModel::Decode(reader, targetPeerDevIK);
        }
        else if (__context_tag == to_underlying(Fields::kPmk))
        {
            err = DataModel::Decode(reader, pmk);
...
CHIP_ERROR Type::Encode(TLV::TLVWriter & aWriter, TLV::Tag aTag) const
{
    ...
    encoder.Encode(to_underlying(Fields::kMobilitySupport), mobilitySupport);
...
CHIP_ERROR DecodableType::Decode(TLV::TLVReader & reader)
{
    ...
    while (true)
    {
        ...
        else if (__context_tag == to_underlying(Fields::kMobilitySupport))
        {
            err = DataModel::Decode(reader, mobilitySupport);
        }
...
{
    DataModel::WrappedStructEncoder encoder{ aWriter, aTag };
    encoder.Encode(to_underlying(Fields::kStartTimeDelay), startTimeDelay);
    encoder.Encode(to_underlying(Fields::kEndTimeDelay), endTimeDelay);
...
CHIP_ERROR DecodableType::Decode(TLV::TLVReader & reader)
{
    ...
    while (true)
    {
        ...
        if (__context_tag == to_underlying(Fields::kStartTimeDelay))
        {
            err = DataModel::Decode(reader, startTimeDelay);
        }
        else if (__context_tag == to_underlying(Fields::kEndTimeDelay))
        {
            err = DataModel::Decode(reader, endTimeDelay);
        }
...
CHIP_ERROR Type::Encode(TLV::TLVWriter & aWriter, TLV::Tag aTag) const
{
    ...
    encoder.Encode(to_underlying(Fields::kStartTimePeriod), startTimePeriod);
    encoder.Encode(to_underlying(Fields::kEndTimePeriod), endTimePeriod);
    return encoder.Finalize();
}
...
CHIP_ERROR DecodableType::Decode(TLV::TLVReader & reader)
{
    ...
    while (true)
    {
        ...
        else if (__context_tag == to_underlying(Fields::kStartTimePeriod))
        {
            err = DataModel::Decode(reader, startTimePeriod);
        }
        else if (__context_tag == to_underlying(Fields::kEndTimePeriod))
        {
            err = DataModel::Decode(reader, endTimePeriod);
        }
...
CHIP_ERROR Type::Encode(TLV::TLVWriter & aWriter, TLV::Tag aTag) const
{
    ...
    encoder.Encode(to_underlying(Fields::kRole), role);
    encoder.Encode(to_underlying(Fields::kTargetPeerDevIK), targetPeerDevIK);
    encoder.Encode(to_underlying(Fields::kPASNCredential), PASNCredential);
    return encoder.Finalize();
}
...
CHIP_ERROR DecodableType::Decode(TLV::TLVReader & reader)
{
    ...
    while (true)
    {
        ...
        else if (__context_tag == to_underlying(Fields::kPASNCredential))
        {
            err = DataModel::Decode(reader, PASNCredential);
        }
